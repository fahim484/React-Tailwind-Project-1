...
export const Note = () => {
  return (
    <section className="pt-[50px] sm:pt-[80px] lg:pt-[100px] xl:pt-[150px] px-2.5">
      <Container className="bg-gradient-primary rounded-custom py-10 md:py-14 pl-6 pr-6 md:pl-10 md:pr-16 flex flex-col md:flex-row justify-between items-center gap-5 md:gap-2.5">
